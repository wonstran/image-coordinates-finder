...
export default function Home() {
  ...
  const [relativeCoordInputMode, setRelativeCoordInputMode] = useState(false);
  ...
  const handleAddPointByRelativeCoord = useCallback(() => {
    const relX = parseFloat(relativeX);
    const relY = parseFloat(relativeY);
    if (!isNaN(relX) && !isNaN(relY) && imageWidth > 0 && imageHeight > 0) {
      const x = relX * imageWidth;
      const y = relY * imageHeight;
      handleShapeAdd({
        type: 'point',
        x,
        y,
      ...
      setRelativeX('');
      setRelativeY('');
      setRelativeCoordInputMode(false);
    }
  }, [relativeX, relativeY, imageWidth, imageHeight, strokeColor, strokeWidth, handleShapeAdd]);
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex">
        <Toolbar
          ...
          relativeCoordInputMode={relativeCoordInputMode}
          onRelativeCoordInputModeChange={setRelativeCoordInputMode}
          relativeX={relativeX}
          onRelativeXChange={setRelativeX}
          relativeY={relativeY}
          onRelativeYChange={setRelativeY}
          onAddPointByRelativeCoord={handleAddPointByRelativeCoord}
        />
